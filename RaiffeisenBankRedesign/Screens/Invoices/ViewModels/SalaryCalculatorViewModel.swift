...
class SalaryCalculatorViewModel: ObservableObject {
    ...
    func pushSalary(finalNetSalary: String, comments : String , accountNumber: String) -> (finalNetSalary: String,comments : String, accountNumber: String) {
        print(finalNetSalary)
        print(comments)
        print(accountNumber)
        
        return (finalNetSalary: finalNetSalary, comments : comments , accountNumber: accountNumber)
    }
}
